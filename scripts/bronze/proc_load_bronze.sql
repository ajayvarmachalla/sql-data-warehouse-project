...
BEGIN
    ...
    BEGIN TRY
        ...
        TRUNCATE TABLE bronze.crm_cust_info; -- First we are making empty the table later adding the data into the table
        PRINT 'Inserting Data Into:bronze.crm_cust_info';
        BULK INSERT bronze.crm_cust_info
        FROM '/tmp/cust_info.csv'
        WITH(
            FIRSTROW = 2, -- This one we are saying first row is header the data starts with 2 row
            FIELDTERMINATOR = ',',
            TABLOCK
        );
        ...
        PRINT 'Inserting Data Into:bronze.erp_local_a101';
        BULK INSERT bronze.erp_local_a101
